 ...
 *
 */
class Value_And_Jacobian_Function extends Multivariate_Jacobian_Function 
{
    /**
     * Compute the value.
     *
     ...
     */
    Real_Vector compute_value(std::vector<double> params);
     ...
     */
    Real_Matrix compute_jacobian(std::vector<double> params);
}
