 ...
 * <br/>
 * The {@link #converged(int,Point_valuePair,Point_valuePair) converged}
 * method will also return {@code true} if the number of iterations has been set
 * (see {@link #Simple_Value_Checker(double,double,int) this constructor}).
 *
 */
class Simple_Value_Checker
    extends AbstractConvergence_Checker<Point_valuePair> 
    {
    /**
     * If {@link #max_iteration_count} is set to this value, the number of
     * iterations will never cause
     * {@link #converged(int,Point_valuePair,Point_valuePair)}
     * to return {@code true}.
     */
    private static const int ITERATION_CHECK_DISABLED = -1;
    /**
     * Number of iterations after which the
     * {@link #converged(int,Point_valuePair,Point_valuePair)} method
     ...
     */
    public Simple_Value_Checker(const double relative_threshold, const double& absolute_threshold) 
    {
     ...
     *
     */
    public Simple_Value_Checker(const double relative_threshold, const double& absolute_threshold, const int max_iter) 
    {
        super(relative_threshold, absolute_threshold);
     ...
     */
    //override
    public bool converged(const int iteration, const Point_valuePair previous, const Point_valuePair current) 
    {
