...
/** Multiplexer for {@link Convergence_Checker}, checking <em>all</em> the checkers converged.
 * <p>
 ...
 * @since 2.1
 */
class Convergence_CheckerAndMultiplexer<P> : Convergence_Checker<P> 
{
     ...
     */
    public Convergence_CheckerAndMultiplexer(const List<Convergence_Checker<P>> checkers) 
    {
