 ...
 * provided: {@link Simple_Value_Checker}, {@link Simple_Vector_Value_Checker} and
 * {@link Simple_Point_Checker}. The first two consider that convergence is
 ...
 *
 * @see org.hipparchus.optim.Simple_Point_Checker
 * @see org.hipparchus.optim.Simple_Value_Checker
 * @see org.hipparchus.optim.Simple_Vector_Value_Checker
 *
 */
class Convergence_Checker<P> 
{
    /**
     ...
     */
    bool converged(const int& iteration, P previous, P current);
}
