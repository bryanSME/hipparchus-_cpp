...
class Midpoint_Integrator extends Runge_Kutta_Integrator 
{
     ...
     */
    public Midpoint_Integrator(const double step) 
    {
        super("midpoint", step);
    }
    ...
    /** {@inherit_doc} */
    //override
    protected Midpoint_State_Interpolator
    ...
    {
        return Midpoint_State_Interpolator(forward, y_dot_k, global_previous_state, global_current_state, global_previous_state, global_current_state, mapper);
    }
