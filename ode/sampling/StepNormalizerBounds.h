...
/** {@link Step_Normalizer Step normalizer} bounds settings. They influence
 ...
 */
public enum Step_Normalizer_Bounds 
{
     ...
     * underlying fixed step size step handler.
     */
    Step_Normalizer_Bounds(const bool first, const bool last) 
    {
        this.first = first;
        this.last = last;
    }
