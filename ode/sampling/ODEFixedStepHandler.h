 ...
 * wrapped within an instance of {@link Step_Normalizer} that itself
 * is used as the general {@link ODE_Step_Handler} by the integrator. The
 * {@link Step_Normalizer} object is called according to the integrator
...
class ODE_Fixed_Step_Handler  
{
     ...
     */
    void handle_step(ODE_State_And_Derivative state, bool is_last);
