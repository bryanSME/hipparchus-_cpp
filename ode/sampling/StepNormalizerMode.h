...
/** {@link Step_Normalizer Step normalizer} modes. Determines how the step size
 * is interpreted.
 * @see FieldStep_Normalizer
 * @see Step_Normalizer
 * @see Step_Normalizer_Bounds
 */
public enum _step_normalizer_mode 
{
    /**
     ...
     * the {@link Step_Normalizer_Bounds bounds settings}), t0+h, t0+2h, ...</p>
     *
     ...
     * tend], depending on the {@link Step_Normalizer_Bounds bounds settings}.
     * </p>
     *
     * @see Step_Normalizer
     * @see Step_Normalizer_Bounds
     ...
     * (depending on the {@link Step_Normalizer_Bounds bounds settings}), t1, * t1+h, t1+2h, ...</p>
     *
     ...
     * handled will be the end point of the integration (tend). If not, * the last point may be the end point tend, or it may be a point
     * belonging to the interval [tend - h ; tend], depending on the
     * {@link Step_Normalizer_Bounds bounds settings}.</p>
     *
     * @see Step_Normalizer
     * @see Step_Normalizer_Bounds
     */
