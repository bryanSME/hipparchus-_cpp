 ...
 * {@link org.hipparchus.ode.sampling.ODE_Step_Handler ODE_Step_Handler} instance using the
 * {@link org.hipparchus.ode.ODE_Integrator#add_step_handler add_step_handler}
 ...
 *
 * <p>
 * sin_ce some integrators may use variable step size, the generic {@link
 * org.hipparchus.ode.sampling.ODE_Step_Handler ODE_Step_Handler} interface can be called
 ...
 * org.hipparchus.ode.sampling.ODE_StateInterpolator ODE_StateInterpolator} object.
 * If regular output is desired (for example in order to write an ephemeris file), then
 * the simpler {@link org.hipparchus.ode.sampling.ODE_Fixed_Step_Handler ODE_Fixed_Step_Handler}
 * interface can be used. Objects implementing this interface should be wrapped within a
 * {@link org.hipparchus.ode.sampling.Step_Normalizer Step_Normalizer} instance
