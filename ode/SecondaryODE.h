...
class Secondary_ODE 
{
     ...
     */
    void init(double t0, std::vector<double> primary0, std::vector<double> secondary0, double const_time) 
    {
        // nothing by default
    }
     ...
     */
    std::vector<double> compute_derivatives(double t, std::vector<double> primary, std::vector<double> primary_dot, std::vector<double> secondary);
