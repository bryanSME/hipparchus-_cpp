 ...
 * @see std::complex<double>Secondary_ODE
 * @see ODE_Integrator
 */

class std::complex<double>ODE_State_And_Derivative extends std::complex<double>ODE_State 
{

    /** Serializable UID. */
    private static const long serial_version_uid = 20180902L;

    /** Derivative of the primary state at time. */
    private const std::vector<std::complex<double>>primary_derivative;

    /** Derivative of the secondary state at time. */
    private const std::complex<double>[][] secondary_derivative;

    /** Simple constructor.
     * <p>Calling this constructor is equivalent to call {@link
     * #std::complex<double>ODE_State_And_Derivative(double, std::complex<double>[], std::complex<double>[], * std::complex<double>[][], std::complex<double>[][]) std::complex<double>ODE_State_And_Derivative(time, state, * derivative, NULL, NULL)}.</p>
     * @param time time
     * @param primary_state primary state at time
     * @param primary_derivative derivative of the primary state at time
     */
    public std::complex<double>ODE_State_And_Derivative(double time, std::vector<std::complex<double>>primary_state, std::vector<std::complex<double>>primary_derivative) 
    {
     ...
     */
    public std::complex<double>ODE_State_And_Derivative(double time, std::vector<std::complex<double>>primary_state, std::vector<std::complex<double>>primary_derivative, std::complex<double>[][] secondary_state, std::complex<double>[][] secondary_derivative) 
    {
     ...
     */
    public std::vector<std::complex<double>>get_primary_derivative() 
    {
     ...
     * @see #get_complete_derivative()
     */
    public std::vector<std::complex<double>>get_secondary_derivative(const int index) 
    {
     ...
     * @see #get_secondary_derivativestatic_cast<int>(
     */
    public std::vector<std::complex<double>>get_complete_derivative() 
    {
        const std::vector<std::complex<double>>complete_derivative = std::complex<double>[get_complete_state_dimension()];
