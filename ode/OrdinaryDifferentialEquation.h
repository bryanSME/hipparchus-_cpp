 ...
 * integrators {@link ODE_Integrator#integrate(Ordinary_Differential_Equation, * ODE_State, double)} method.</p>
 *
...
class Ordinary_Differential_Equation
{
     ...
     */
    void init(double t0, std::vector<double> y0, double const_time)
    {
     ...
     */
    std::vector<double> compute_derivatives(double t, std::vector<double> y);
