 ...
 * integrators {@link First_Order_Converter converter to first order}.</p>
 *
...
class Second_Order_ODE 
{
     ...
     */
    std::vector<double> compute_second_derivatives(double t, std::vector<double> y, std::vector<double> y_dot);
