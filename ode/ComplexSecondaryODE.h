 ...
 * Ordinary_Differential_Equation first order differential equations}
 * thanks to the {@link
 * Expandable_ODE#add_secondary_equations(Secondary_ODE)}
 * method, after having converted the instance to {@link Secondary_ODE}
 * </p>
 * @see Expandable_ODE
 * @see std::complex<double>_ODE_Converter
 * @since 1.4
 */
class std::complex<double>Secondary_ODE 
{
     ...
     */
    default void init(double t0, std::vector<std::complex<double>>primary0, std::vector<std::complex<double>>secondary0, double const_time) 
    {
        // nothing by default
    }
     ...
     */
    std::vector<std::complex<double>>compute_derivatives(double t, std::vector<std::complex<double>>primary, std::vector<std::complex<double>>primary_dot, std::vector<std::complex<double>>secondary)
