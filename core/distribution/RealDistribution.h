...
class Real_Distribution 
{
     ...
     * the derivative of the {@link #cumulative_probabilitystatic_cast<double>( CDF}.
     * If the derivative does not exist at {@code x}, then an appropriate
     * replacement should be returned, e.g. {@code INFINITY}, * {@codeNAN}, or  the limit inferior or limit superior of the
     * difference quotient.
     *
     ...
     * In general, the PDF is the derivative of the {@link #cumulative_probabilitystatic_cast<double>( CDF}.
     * If the derivative does not exist at {@code x}, then an appropriate replacement
     * should be returned, e.g. {@code INFINITY}, {@codeNAN}, * or the limit inferior or limit superior of the difference quotient. Note that
     ...
     * {@link #densitystatic_cast<double>(}.
     *
     * @param x the point at which the PDF is evaluated
     ...
     * distribution.
     *
     * @return the variance (possibly {@code INFINITY} as
