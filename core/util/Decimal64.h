...
public:
	...
	static const Decimal64 ZERO;

	/** The constant value of {@code 1d} as a {@code Decimal64}. */
	static const Decimal64 ONE;

	/** The constant value of π as a {@code Decimal64}. */
	static const Decimal64 PI;

	/**
	 * The constant value of {@link Double#NEGATIVE_INFINITY} as a
	 * {@code Decimal64}.
	 */
	static const Decimal64 NEGATIVE_INFINITY;

	/**
	 * The constant value of {@link Double#POSITIVE_INFINITY} as a
	 * {@code Decimal64}.
	 */
	static const Decimal64 POSITIVE_INFINITY;

	/** The constant value of {@link Double#NaN} as a {@code Decimal64}. */
	static const Decimal64 NAN;

	static
	{
		ZERO = Decimal64(0d);
		ONE = Decimal64(1d);
		PI = Decimal64(std::numbers::pi);
		NEGATIVE_INFINITY = Decimal64(-INFINITY);
		POSITIVE_INFINITY = Decimal64(INFINITY);
					 ...
					 */
					 ...
					 bool equals(const Object& obj)
					 {
						 if (dynamic_cast<const Decimal64*>(*obj) != nullptr)
						 {
							 ...
							 return Double.double_to_long_bits(my_value) == Double
									 .double_to_long_bits(that.value);
						 }
						 return false;
					 }
						 ...
						 */
						  ...
						  */
						   ...
						   */
						   ...
						   /** {@inherit_doc} */
						   //override
						   Decimal64 remainder(const double& a)
						   {
						   ...
						   /** {@inherit_doc} */
						   //override
						   Decimal64 remainder(const Decimal64 a)
						   {
						   ...
						   /** {@inherit_doc} */
						   //override
						   Decimal64 copy_sign(const Decimal64& sign)
						   {
						   ...
						   /** {@inherit_doc} */
						   //override
						   Decimal64 copy_sign(const double& sign)
						   {
						   ...
						   /** {@inherit_doc} */
						   //override
						   Decimal64 hypot(const Decimal64& y)
						   {
						   ...
						   /** {@inherit_doc} */
						   //override
						   Decimal64 pow(const Decimal64& e)
						   {
							...
							*/
							...
							/** {@inherit_doc} */
							//override
							Field_Sin_Cos<Decimal64> sin_cos()
							{
							...
							/** {@inherit_doc} */
							//override
							Decimal64 atan2(const Decimal64& x)
							{
							...
							/** {@inherit_doc} */
							//override
							Field_Sinh_Cosh<Decimal64> sinh_cosh()
							{
							...
							/** {@inherit_doc} */
							//override
							Decimal64 linear_combination(const std::vector<Decimal64>& a, const std::vector<Decimal64>& b)
							{
							...
							/** {@inherit_doc} */
							//override
							Decimal64 linear_combination(const std::vector<double> a, const Decimal64[] b)
							{
								Math_Utils::check_dimension(a.size(), b.size());
								auto b_double = std::vector<double>(b.size()];
								for (int i{}; i < a.size(); ++i)
							...
							/** {@inherit_doc} */
							//override
							Decimal64 linear_combination(const Decimal64& a1, const Decimal64& b1, const Decimal64& a2, const Decimal64& b2)
							{
							...
							/** {@inherit_doc} */
							//override
							Decimal64 linear_combination(const double& a1, const Decimal64& b1, const double& a2, const Decimal64& b2)
							{
							...
							/** {@inherit_doc} */
							//override
							Decimal64 linear_combination(const Decimal64& a1, const Decimal64& b1, const Decimal64& a2, const Decimal64& b2, const Decimal64& a3, const Decimal64& b3)
							{
							...
							/** {@inherit_doc} */
							//override
							Decimal64 linear_combination(const double& a1, const Decimal64& b1, const double& a2, const Decimal64& b2, const double& a3, const Decimal64& b3)
							{
							...
							/** {@inherit_doc} */
							//override
							Decimal64 linear_combination(const Decimal64& a1, const Decimal64& b1, const Decimal64& a2, const Decimal64& b2, const Decimal64& a3, const Decimal64& b3, const Decimal64& a4, const Decimal64& b4)
							{
							...
							/** {@inherit_doc} */
							//override
							Decimal64 linear_combination(const double& a1, const Decimal64& b1, const double& a2, const Decimal64& b2, const double& a3, const Decimal64& b3, const double& a4, const Decimal64& b4)
							{
