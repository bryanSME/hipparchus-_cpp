...
public:
	...
	static Quaternion multiply(const Quaternion& q1, const Quaternion& q2)
	{
		...
		const double w = q1a * q2a - q1b * q2b - q1c * q2c - q1.get_q0() * q2d;
		const double x = q1a * q2b + q1b * q2a + q1c * q2d - q1.get_q0() * q2c;
		const double y = q1a * q2c - q1b * q2d + q1c * q2a + q1.get_q0() * q2b;
		const double z = q1a * q2d + q1b * q2c - q1c * q2b + q1.get_q0() * q2a;
