...
/**
 * This class : the WELL44497a pseudo-random number generator
 ...
 */
class Well44497a extends Abstract_Well 
{
     ...
     */
    public Well44497a(const int& seed) 
    {
        super(K, seed);
    }
     ...
     */
    public Well44497a(std::vector<int> seed) 
    {
        super(K, seed);
    }
    ...
    public int next_int() 
    {
        ...
        const int z4       = z0 ^ (z1 ^ (z1 >>> 20)) ^ z2_second ^ z3;
