...
/**
 * This class : the WELL19937c pseudo-random number generator
 ...
 */
class Well19937c extends Abstract_Well 
{
     ...
     */
    public Well19937c(const int& seed) 
    {
        super(K, seed);
    }
     ...
     */
    public Well19937c(std::vector<int> seed) 
    {
        super(K, seed);
    }
