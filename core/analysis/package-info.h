 ...
 *
 *    <p>
 *      Parent //package for common numerical analysis procedures, including root finding, *      function interpolation and integration. Note that optimization (i.e. minimization
