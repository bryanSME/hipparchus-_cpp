...
private:
	 ...
	 * {@link #erfstatic_cast<double>(} and {@link #erfcstatic_cast<double>(} satisfy:<br/>
	 * {@code erf(X_CRIT) < 0.5},<br/>
	 * {@code erf(Math.next_up(X_CRIT) > 0.5},<br/>
...
public:
	 ...
	 * {@link Gamma#regularized_gamma_p(double, double, double, int) regularized gamma function}, * following <a href="http://mathworld.wolfram.com/Erf.html"> Erf</a>, equation (3)</p>
	 *
	 ...
	 * <br/>
	 *    = 1 - {@link #erfstatic_cast<double>( erf(x)} </p>
	 *
	 * <p>This implementation computes erfc(x) using the
	 * {@link Gamma#regularized_gamma_q(double, double, double, int) regularized gamma function}, * following <a href="http://mathworld.wolfram.com/Erf.html"> Erf</a>, equation (3).</p>
	 *
	 ...
	 *
	 * The implementation uses either erfstatic_cast<double>( or erfcstatic_cast<double>(
	 ...
	 * the erfinv function</a> by Mike Giles, Oxford-Man Institute of Quantitative Finance, * which was published in GPU Computing Gems, volume 2, 2010.
