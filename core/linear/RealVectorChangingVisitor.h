 ...
 *
 */
class Real_Vector_Changing_Visitor 
{
    /**
     ...
     */
    double visit(const int& index, double value);
     ...
     * {@link Real_Vector#walk_in_default_order(Real_Vector_Changing_Visitor)}, * {@link Real_Vector#walk_in_default_order(Real_Vector_Changing_Visitor, int, int)}, * {@link Real_Vector#walk_in_optimized_order(Real_Vector_Changing_Visitor)}
     * or
     * {@link Real_Vector#walk_in_optimized_order(Real_Vector_Changing_Visitor, int, int)}
     */
    double end();
}
