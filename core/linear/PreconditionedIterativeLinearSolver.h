 ...
 */
  ...
  */
   ...
   *
   */
class PreconditionedIterative_Linear_Solver : public Iterative_Linear_Solver
{
	/**
	 ...
	 * has been set at construction of the {@link Iteration_Manager}
	 */
	public Real_Vector solve(const Real_Linear_Operator& a, const Real_Linear_Operator& m, const Real_Vector& b)
	{
		//Math_Utils::check_not_null(a);
		const Real_Vector x = Array_Real_Vector(a.get_column_dimension());
	 ...
	 * has been set at construction of the {@link Iteration_Manager}
	 */
	public virtual Real_Vector solve_in_place(const Real_Linear_Operator& a, const Real_Linear_Operator& m, const Real_Vector& b, const Real_Vector& x0);
