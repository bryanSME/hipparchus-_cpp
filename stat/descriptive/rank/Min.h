 ...
 */
class Min : public Abstract_Storeless_Univariate_Statistic //, public Aggregatable_Statistic<Min>
{
private:
...
public:
     ...
     */
    Min() : my_n{ 0 }, my_value{ std::numeric_limits<double>::quiet_NaN() } {};

    /**
     * Copy constructor, creates a {@code Min} identical
    ...
    /** {@inherit_doc} */
    //override
    void aggregate(const Min& other)
    {
    ...
    {
        auto min = std::numeric_limits<double>::quiet_NaN();
