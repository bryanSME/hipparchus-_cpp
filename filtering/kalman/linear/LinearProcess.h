 ...
 */
 ...
 /**
  * Linear process that can be estimated by a {@link Linear_Kalman_Filter}.
  * <p>
  ...
  * @see Linear_Kalman_Filter
  * @see org.hipparchus.filtering.kalman.extended.Non_Linear_Process
  * @since 1.3
  */
class Linear_Process<T extends Measurement>
{
	/** Get the state evolution between two times.
	 * @param measurement measurement to process
	 * @return state evolution
	 */
	Linear_Evolution get_evolution(T measurement);
}